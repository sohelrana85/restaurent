@extends('admin.layouts.app', ['title' => 'Update Foods'])
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Update Food</h4>
                    ...
                    <form action="{{route('foods.update', $food->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{$food->title}}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea name="desc" id="desc" cols="30" rows="5" class="form-control @error('desc') is-invalid @enderror">{{$food->desc}}</textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{$food->price}}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-3" style="text-align:center;">
                                <img src="{{asset('food_image').'/'.$food->image}}" alt="" style="width: 120px">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-3">status</label>
                            <div class="col-sm-9">
                                <input type="radio" id="statusinput1" class="form-check-input" name="status" value="1" {{$food->status == 1 ? 'checked' : ''}}>
                                <label for="statusinput1" class="form-check-label" style="margin-right: 20px">Active</label>
                                <input type="radio" id="statusinput2" class="form-check-input" name="status" value="0" {{$food->status == 0 ? 'checked' : ''}}>
